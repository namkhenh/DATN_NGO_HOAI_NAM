...
namespace Portal.Infrastructure.Persistence.Migrationsad
{
    /// <inheritdoc />
    public partial class Initdataproject : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PermissionDepartments", x => x.Id);
                });
