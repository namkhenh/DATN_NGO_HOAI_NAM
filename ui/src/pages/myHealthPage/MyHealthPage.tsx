    ...
    <div id='my-health' className='my-health'>
      <div className="myhealth-container">
        ...
        <div className="health-info">
          <Button sx={{ borderRadius: '50%', width: '32px', height: '32px' }} onClick={() => { openUpdate(MyHealthFormType.UpdateInfo) }}>
            <ModeEditIcon />
          </Button>
        ...
        <div className="health-index">
          <div className="health-index-wrap">
            <div className="health-index-left">
              ...
              </div> : <Button variant={ButtonVariantType.Text} onClick={() => { openUpdate(MyHealthFormType.BMI) }}>Tính</Button>}
            </div>
          ...
          <div className="health-index-wrap">
            <div className="health-index-left">
              ...
              {false ? <div className="index-update">
                Cập nhật 29 ngày trước
              </div> : <Button variant={ButtonVariantType.Text} onClick={() => { openUpdate(MyHealthFormType.BMR) }}>Tính</Button>}
            </div>
            <div className="health-index-right">
              <div className="index-detail-button">
                Chi tiết <KeyboardArrowRightIcon />
          ...
          <div className="health-index-wrap">
            <div className="health-index-left">
              ...
              {false ? <div className="index-update">
                Cập nhật 29 ngày trước
              </div> : <Button variant={ButtonVariantType.Text} onClick={() => { openUpdate(MyHealthFormType.HeartBeat) }}>Tính</Button>}
            </div>
            <div className="health-index-right">
              <div className="index-detail-button">
                Chi tiết <KeyboardArrowRightIcon />
