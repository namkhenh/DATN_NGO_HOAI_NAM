                        ...
                        <div className="info-body">
                            <div className="info-body-wrap">
                                ...
                                <div className="user-info-item">
                                    ...
                                    <span>Địa chỉ:</span>
                                    <Tooltip title={'asdasdasd'} placement="top-start">
                                        <div className='item-detail'>{'asfasdasd'}</div>
                                    </Tooltip>
                                </div>
                            </div>
                            <div className="info-body-wrap">
                ...
                <div className="page-edit-container">
                    <TabContext value={tabValue}>
                        ...
                        <TabPanel value={UserInfoDetailTabType.MainInfo}><UserMainInfo
                            userMainInfo={userInfo}></UserMainInfo></TabPanel>
                        <TabPanel value={UserInfoDetailTabType.OtherInfo}><UserOtherInfo
                            userOtherInfo={userInfo}></UserOtherInfo></TabPanel>
                    </TabContext>
                </div>
            </div>
        );
