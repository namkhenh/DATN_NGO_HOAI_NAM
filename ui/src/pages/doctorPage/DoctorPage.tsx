            ...
            <div className='doctor-contaier'>
                <div className="content">
                    ...
                    <div className="doctor-sub-title">
                        Nhân viên chăm sóc sức khỏe toàn diện của chúng tôi trao quyền cho bệnh nhân bằng các công cụ & kiến thức tự chăm sóc
                    </div>
                    <div className="doctor-content">
                        Với thông tin ấn tượng và nhiều thập kỷ kinh nghiệm, các bác sĩ tại Phòng khám Riordan cung cấp dịch vụ chăm sóc và chuyên môn tốt nhất. Đội ngũ nhân viên xuất sắc của chúng tôi bao gồm các chuyên gia giàu kinh nghiệm và chu đáo, những người sẽ dành thời gian của bạn tại Phòng khám Riordan trong số những trải nghiệm y tế tốt nhất trong cuộc đời bạn.
                    </div>
