                    ...
                    <div className="list-appointment-detail">
                        ...
                        <div className="list-appointment-wrap">
                            {currentSelection === -1 ? 
                                ...
                                <LinkOffOutlinedIcon sx={{ fontSize: '96px', color: '#cccccc', marginBottom: '12px' }}></LinkOffOutlinedIcon>
                    ...
                    {currentSelection !== -1 &&
                        <div className="appointment-hotline">
                            ...
                            <div className="hotline">
                                Lịch khám của bạn đã được gửi đi. Vui lòng đợi <strong>Riordan Clinic</strong> xác nhận. Mọi yêu cầu về <strong>Hủy lịch/ Đổi lịch</strong> vui lòng gọi Hotline <strong>19001234</strong> để được hỗ trợ.<br />Trân trọng cảm ơn!
                            </div>
                        </div>}
                </div>
            </div>
