...
class UserInfo extends React.Component<any, UserInfoState> {
    ...
    render() {
        const { userAvatar, userName, userSex, userNational, userDateBirth, userPhoneNumber, userIdentityNumber, userAddress, userInsuranceNumber, userCardPeriodFrom, userCardPeriodTo, userReligion, userJob } = this.state.userInfoState
            ...
            <div id='user-info' className='user-info'>
                ...
                <div className="page-info-container">
                    <div className="info-avatar">
                        ...
                        <div className="info-avatar-wrap">
                            <Avatar variant="rounded" alt={userName} src={userAvatar} sx={{ width: '132px', height: '132px' }} />
                        ...
                        <div className="info-body">
                            <div className="info-body-wrap">
                                <div className="user-info-item">
                                    ...
                                    <span>Ngày sinh:</span>
                                    <div className='item-detail'>{`${new Date(userDateBirth).getDate()}/${new Date(userDateBirth).getMonth()+1}/${new Date(userDateBirth).getFullYear()}`}</div>
                                </div>
                                <div className="user-info-item">
                ...
                <div className="page-edit-container">
                    <TabContext value={tabValue}>
                        <TabList onChange={(event: React.SyntheticEvent, newValue: string) => { this.setState({tabValue: newValue})}} aria-label="lab API tabs example">
                        ...
                        <TabPanel value={UserInfoDetailTabType.MainInfo}><UserMainInfo userMainInfo={this.state.userInfoState}></UserMainInfo></TabPanel>
                        <TabPanel value={UserInfoDetailTabType.OtherInfo}><UserOtherInfo userOtherInfo={this.state.userInfoState}></UserOtherInfo></TabPanel>
                    </TabContext>
                </div>
            </div>
        );
