...
export default class LandingPage extends React.Component<any, LandingPageState> {
    ...
    componentDidMount(): void {
        this.setState({
            fieldContent: [
                { icon: field1, title: 'Chăm sóc sức khỏe1', subTitle: '', link: '/linh-vuc-chi-tiet1' },
                { icon: field2, title: 'Chăm sóc sức khỏe2', subTitle: 'aaaaaaaaaaaaaaaaaaaaaaaaaaaa', link: '/linh-vuc-chi-tiet2' },
                { icon: field3, title: 'Chăm sóc sức khỏe3', subTitle: 'aaaaaaaaaaaaaaaaaaaaaaaaaaaa', link: '/linh-vuc-chi-tiet3' },
                { icon: field4, title: 'Chăm sóc sức khỏe4', subTitle: 'aaaaaaaaaaaaaaaaaaaaaaaaaaaa', link: '/linh-vuc-chi-tiet4' },
                { icon: field5, title: 'Chăm sóc sức khỏe5', subTitle: 'aaaaaaaaaaaaaaaaaaaaaaaaaaaa', link: '/linh-vuc-chi-tiet5' },
                { icon: field6, title: 'Chăm sóc sức khỏe6', subTitle: 'aaaaaaaaaaaaaaaaaaaaaaaaaaaa', link: '/linh-vuc-chi-tiet6' },
                { icon: field7, title: 'Chăm sóc sức khỏe7', subTitle: 'aaaaaaaaaaaaaaaaaaaaaaaaaaaa', link: '/linh-vuc-chi-tiet7' },
                { icon: field8, title: 'Chăm sóc sức khỏe8', subTitle: 'aaaaaaaaaaaaaaaaaaaaaaaaaaaa', link: '/linh-vuc-chi-tiet8' },
            ],
            teamContent: [
            ...
            feedbackContent: [
                { avatar: team1, name: 'Nguyễn Văn A', job: 'Sinh viên', feedback: 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', rate: 4 },
                { avatar: team1, name: 'Nguyễn Văn A', job: 'Sinh viên', feedback: 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', rate: 5 },
                { avatar: team1, name: 'Nguyễn Văn A', job: 'Sinh viên', feedback: 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', rate: 3 },
                { avatar: team1, name: 'Nguyễn Văn A', job: 'Sinh viên', feedback: 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', rate: 4 },
            ],
        })
    }
            ...
            <div className="langding-container">
                <div className="landing-banner">
                    <div className="banner-container">
                        ...
                        <div className="view-more-button">
                            <Button variant={ButtonVariantType.Contained} endIcon={<ArrowForwardIosIcon sx={ {marginLeft: '120px'}} />}>
                                <span>XEM THÊM</span>
                            </Button>
                        </div>
                    </div>
                    ...
                    <div className="landing-about-us-left">
                        ...
                        <div className="left-management">
                            ...
                            <div className="book-appoinment-button">
                                <Button variant={ButtonVariantType.Contained} startIcon={<EventAvailableIcon sx={{fontSize: '30px'}}/>}>
                ...
                <div className="landing-fields">
                    ...
                    <div className="fields-wrap">
                        {this.state.fieldContent?.map((item) => {
                            return <LandingField
                                icon={item.icon}
                                title={item.title}
                ...
                <div className="landing-teams">
                    ...
                    <div className="teams-wrap">
                        {this.state.teamContent?.map((item) => {
                            return <LandingTeam
                                avatar={item.avatar}
                                name={item.name}
                ...
                <div className="landing-feedback">
                    ...
                    <div className="feedback-wrap">
                        {this.state.feedbackContent?.map((item) => {
