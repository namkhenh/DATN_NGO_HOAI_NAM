...
import { ICountry, IDistrict, IProvince, IUserAddress, IUserInfoViewModel, UserAddressModelProperty, UserInfoModelProperty, UserSexView } from '../../../model/apimodel/userInfo';
                ...
                <div className='user-main-container'>
                    <div className="user-main-detail">
                        <TextField
                            ...
                            onChange={(_, value) => { onChangeOneField(UserInfoModelProperty.userInsuranceNumber, value) }}
                    ...
                    <div className="user-main-detail">
                        <DatePicker
                            ...
                            onSelectDate={(date) => { onChangeOneField(UserInfoModelProperty.userCardPeriodFrom, `${date?.getMonth()}/${date?.getDay()}/${date?.getFullYear()}`) }}
                    ...
                    <div className="user-main-detail">
                        <DatePicker
                            ...
                            // strings={defaultDatePickerStrings}
                            onSelectDate={(date) => { onChangeOneField(UserInfoModelProperty.userCardPeriodTo, `${date?.getMonth()}/${date?.getDay()}/${date?.getFullYear()}`) }}
                    ...
                    <div className="user-main-detail">
                        <TextField
                            ...
                            onChange={(_, value) => { onChangeOneField(UserInfoModelProperty.userReligion, value) }}
                    ...
                    <div className="user-main-detail">
                        <TextField
                            ...
                            onChange={(_, value) => { onChangeOneField(UserInfoModelProperty.userJob, value) }}
