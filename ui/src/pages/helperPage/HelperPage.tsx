    ...
    return (
        <div className='helper-page'>
            ...
            <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
                ...
                <AccordionDetails>
                    <Typography>
                        Đăng ký tài khoản thành viên ở Riordan Clinic đem lại cho bạn nhiều lợi ích hơn như giúp bạn lưu trữ các thông tin sức khỏe cá nhân, đặt lịch khám với bác sĩ, tham gia các cộng đồng sức khỏe của Riordan Clinic cũng như hỗ trợ Riordan Clinic cá nhân hóa trải nghiệm sử dụng nền tảng của bạn.
                    </Typography>
                </AccordionDetails>
            </Accordion>
            ...
            <Accordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
                ...
                <AccordionDetails>
                    <Typography>
                        Sử dụng Riordan Clinic không thay thế cho việc khám bệnh cùng một chuyên gia y tế. Chúng tôi không cung cấp các chẩn đoán, lời khuyên hay điều trị y khoa. Hãy luôn luôn tham vấn ý kiến bác sĩ hoặc chuyên gia - những người có chuyên môn và thẩm quyền.
                    </Typography>
                </AccordionDetails>
            </Accordion>
